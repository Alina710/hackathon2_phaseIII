...
- 8 user stories covering authentication (P1), todo CRUD (P2-P3), and responsive design (P4)
- 28 functional requirements organized by domain (Auth, Todo, API, Frontend)
